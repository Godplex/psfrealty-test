...
const getPropertyByPostalCode = (req, res) => {
    ...
    let listHome = parseJsonData.filter((element) => element.postalCode.toString() === query && element.property_type === "RNT")

    res.status(200).json(listHome.splice(0, 15))
}

export default getPropertyByPostalCode;